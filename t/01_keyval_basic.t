...
=== conf zone too small
--- http_config
keyval_zone zone=test:1k;
keyval $cookie_data_key $keyval_data zone=test;
--- config
--- must_die

=== conf zone missing size
--- http_config
keyval_zone zone=test;
keyval $cookie_data_key $keyval_data zone=test;
--- config
--- must_die

=== conf zone invalid size
--- http_config
keyval_zone zone=test:abc;
keyval $cookie_data_key $keyval_data zone=test;
--- config
--- must_die

=== conf zone unknown parameter
--- http_config
keyval_zone zone=test:1M foo=bar;
keyval $cookie_data_key $keyval_data zone=test;
--- config
--- must_die

=== conf duplicate keyval_zone
--- http_config
keyval_zone zone=test:1M;
keyval_zone zone=test:1M;
keyval $cookie_data_key $keyval_data zone=test;
